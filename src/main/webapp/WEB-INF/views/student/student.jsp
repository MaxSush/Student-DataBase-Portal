...
<title>MMEC - View Students</title>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a
																href="student-details?usn=${student.usn}&sem=${student.sem}&name=${student.firstName}&regid=${regid}&id=${id}">${student.firstName}</a>
														</h2>
													</td>
													<td>${student.sem}</td>
													<td>${student.dob}</td>
													...
													<td class="text-end">
														<div class="actions ">
															<a href="javascript:;"
																...
																href="edit-student-info?id=${student.id}&usn=${student.usn}&regid=${regid}"
