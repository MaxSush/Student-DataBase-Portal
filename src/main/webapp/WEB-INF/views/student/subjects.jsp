	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<form action="getAllSubjects?usn=${usn}&name=${name}&sem=${sem}&regid=${regid}&id=${id}" method="post">
					...
					<c:when test="${subject!=null}">
						<c:forEach var="subject" items="${ subjects}" varStatus="loop">
						  <c:if test="${!processedSemesters.contains(subject.sem)}">
						   <c:set var="dummy" value="${processedSemesters.add(subject.sem)}" />
													...
													<c:if test="${s.sem==subject.sem }">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<h2>
																			<a href="student-get-notes?usn=${usn}&name=${name}&sem=${sem}&regid=${regid}&id=${id}&subjectCode=${s.subjectCode}&subjectName=${s.subjectName}">${s.subjectName }</a>
																		</h2>
																	</td>
																	<td>${s.sem }</td>
																	<td>${s.department }</td>
