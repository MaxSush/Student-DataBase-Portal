					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="form-group">
								<form id="semForm"
									action="StudentBySem?usn=${usn }&firstname=${firstname}&lastname=${lastname}&adminRegId=${adminRegId}&department=${department}"
									method="post">
						...
						<div class="col-lg-4 col-md-6">
							<div class="form-group">
								<form
									action="promote-sem?usn=${usn }&firstname=${firstname}&lastname=${lastname}&adminRegId=${adminRegId}&department=${department}"
									method="post">
									<c:forEach var="student" items="${allstudents}">
										<input type="hidden" name="idList" value="${student.id}">


									</c:forEach>
									<input type="hidden" name="sem" value="${studentSem}">
									<select class="form-control select" name="nextSem"
										required="required">
										<option>Promote Semester..</option>
										<option>1</option>
										<option>2</option>
										<option>3</option>
										<option>4</option>
