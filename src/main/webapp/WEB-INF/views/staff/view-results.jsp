			...
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="card">
							<div class="card-body">
								<form
									action="viewResults?usn=${usn }&name=${name}&lastname=${lastname}&staffregid=${staffregid}"
									method="post">
									<div class="row">
										<div class="col-12">
											<h5 class="form-title">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												<label>Student USN <span class="login-danger">*</span></label>
												<input type="text" class="form-control" name="studentUsn" value="${studentUsn }"
													required="required">
											</div>
										</div>
										<div class="col-12 col-sm-4">
				...
				<c:choose>
					<c:when test="${result!=null}">
						<c:forEach var="result" items="${result}" varStatus="loop">
							<c:if test="${!processedSemesters.contains(result.sem)}">
						


								<c:set var="dummy" value="${processedSemesters.add(result.sem)}" />
									...
									<div class="card card-table">
										<div class="card-body">
											...
											<div class="page-header">
												<div class="row align-items-center">
													<div class="col">
														<h3 class="page-title">Semester - ${result.sem }
															${result.examType} Exam Result</h3>
													</div>
