...
<title>MMEC - Staff Dashboard</title>
...
<link
    ...
    .page-wrapper:before {
        content: "";
        background-image: url('assets/mmec.webp'); /* Add the path to your image */
  ...
  font-weight: 600; /* Adjust font size as needed */
    ...
    @media (max-width: 768px) {
     ...
     .footer {
        content: "";
        background-image: url('assets/logo.webp'); /* Add the path to your image */
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="staff-dashboard?usn=${usn}&name=${name}&lastname=${lastname }&staffregid=${staffregid}" class="logo" style="background-color:royalblue;width:95%; border-radius:5px;"> <img src="assets/mmec1.jpg"
					alt="Logo">
					...
					<ul>
						...
						<li class="submenu active"><a href="#"><i
							...
							<ul>
								...
								<li><a href="staff-dashboard?usn=${usn}&name=${name}&lastname=${lastname }&staffregid=${staffregid}" class="active">Staff
										Dashboard</a></li>

							</ul></li>

						<li class="submenu"><a href="#"><i
								class="fas fa-chalkboard-Staff"></i> <span> Staff</span> <span
								class="menu-arrow"></span></a>
							<ul>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Welcome Prof. ${name } ${lastname }</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="staff-dashboard?usn=${usn}&name=${name}&lastname=${lastname}&staffregid=${staffregid}">Home</a></li>
    ...
    <h2 class="heading">MARATHA MANDAL ENGINEERING COLLEGE BELAGAVI</h2>
     ...
     <footer class="footer">
         <!-- Add your logo image -->
        <div>
            <a href="https://www.mmec.edu.in/index.php/about-us/" target="_blank">About Us</a>
            <a href="https://www.mmec.edu.in/" target="_blank">More</a>
        </div>
    </footer>
</div>
