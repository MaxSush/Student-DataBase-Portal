			...
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="card">
							<div class="card-body">
								<form action="Add-students?usn=${usn }&firstName=${firstName}&lastName=${lastName}&acRegId=${acRegId}&Acdepartment=${department}" method="post" enctype="multipart/form-data">
									<div class="row">
										<div class="col-12">
											<h5 class="form-title">
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
												<label> Total Fees Amount</label> <input type="text"
													class="form-control" name="totalAmout" required="required">
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="form-group">
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
												<label>Seat Category</label> <select class="form-control select" name="seatCategory" required="required">
													
													<option>${seatCategory }</option>
