	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="student-dashboard" class="logo"> <img
					src="assets/img/logo.png" alt="Logo">
				</a> <a href="student-dashboard" class="logo logo-small"> <img
				...
				<li class="nav-item dropdown has-arrow new-user-menus"><a
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="profile">My Profile</a> <a
							class="dropdown-item" href="inbox">Inbox</a> <a
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu"><a href="#"><i
								...
								class="menu-arrow"></span></a>
							<ul>
								<li><a href="add-fees"><i class="fas fa-comment-dollar"></i>
									...
									<div class="row align-items-center">
										...
										<div class="col-auto text-end float-end ms-auto download-grp">
											<a href="#" class="btn btn-outline-primary me-2"><i
												...
												href="add-fees" class="btn btn-primary"><i
